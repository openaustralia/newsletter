...
Nick Evershed and The Guardian's datablog are enticing their NSW readers to help investigate the state’s register of pecuniary interests. They’re using technology to crowdsource transcriptions to change the form this data is available to the public. By transcribing all these entries, together, we create a new data set, one which is open to search, scrutiny and analysis. It’s one of those situations where neither parliament nor politicians have previously shown any interest in making this data accessible and usable.

Here citizens and journalists can collectively transform that information into structured usable data which fundamentally changes the power balance.
